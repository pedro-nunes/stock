                ...
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="document" id="document"
                            data-inputmask="'mask':'999.999.999-99'" value="613.311.588-26" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4 col-md-3">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="phone" id="phone"
                            data-inputmask="'mask':'99 9999-9999[9]'" value="11 98764-4321" required>
                    </div>
                </div>
                <div class="col-sm-4 col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" id="email"
                            value="pedro@multiverso.com" required>
                    </div>
                </div>
            </div>
            <hr>
                ...
                <div class="col-12 col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="zip" id="zip"
                            data-inputmask="'mask':'99999-999'" value="08615-300">
                    </div>
                </div>
                ...
                <div class="col-12 col-sm">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="district" id="district"
                            value="Vila Nova Amorim">
                    </div>
                </div>
                <div class="col-12 col-sm">
                    <div class="form-group">
                        <label for="city">Cidade:</label>
                        <input type="text" class="form-control" name="city" id="city" value="Suzano">
                    </div>
                </div>
                <div class="col-12 col-sm-1 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="state" id="state" maxlength="2"
                            data-inputmask="'mask':'AA'" value="SP">
                    </div>
                </div>
            </div>
            <div class="row">
